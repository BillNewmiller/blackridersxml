...
religion.divs.ns.l <- getNodeSet(doc, "//tei:div2[@ana='#theme-mind']//tei:w[@ana='#ref-object']/ancestor-or-self::node()[position()=2]", namespaces = c(tei = "http://www.tei-c.org/ns/1.0"))
objects.v <- sapply(religion.divs.ns.l, xmlValue)
objects.v
